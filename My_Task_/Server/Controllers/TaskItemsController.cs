...
namespace My_Task_.Server.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class TaskItemsController : ControllerBase
    {
        private readonly My_Task_ServerContext _context;

        public TaskItemsController(My_Task_ServerContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<TaskItem>> PostTaskItem(TaskItem taskItem)
        {
            if (_context.TaskItem == null)
            {
                return Problem("Entity set 'My_Task_ServerContext.TaskItem'  is null.");
            }
